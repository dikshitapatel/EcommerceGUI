...
<div class="row" style="text-align: left;padding-left: 100px;font-size: 17px;padding-right: 100px;">
  <br><br>
 <h2 style="padding-left: 350px;font-weight: bold;">Meet The People Behind Klassyink<br><br></h2> 
 <h4 style="font-weight: bold;">No Company Can Excel Without Brilliant And Like Inclined People, So Meet Our Rockstars Who Are Behind The Success Of</h4> 
  <h4 style="font-weight: bold;padding-left: 550px ;">Klassyink</h4>
  <h4 style="font-weight: bold;line-height: 2">WE don’t brag, we conquer virality.A crazy team of young, creative, spontaneous, enthusiastic & Klassy people who always believe in pushing the limits to work 24 hours a day.The only one thing that keeps us going day and night is our passion for </h4>
  <h4 style="font-weight: bold;padding-left: 550px">creating an impact</h4>

</div>
<div class="row" style="text-align: left;padding-top: 40px;padding-left:100px;padding-right: 20px;">
  <div class="col-sm-3">
    <h5 style="font-weight: bold;">Jitendra sahu</h5>
    <h5 style="font-weight: bold;">Founder and CEO</h5>
 </div>
  <div class="col-sm-3">
    <h5 style="font-weight: bold;">Sahil Mahtre</h5>
    <h5 style="font-weight: bold;">Chief Operational Officer</h5>

  </div>
  <div class="col-sm-3">
    <h5 style="font-weight: bold;">Keval Shah</h5>
    <h5 style="font-weight: bold;">Chief Marketing Officer</h5>

  </div>
  <div class="col-sm-3">
    <h5 style="font-weight: bold;">Shekhar Varma</h5>
    <h5 style="font-weight: bold;">Chief Design Officer</h5>


  </div>
  <div class="row" >
    <h4 style="font-weight: bold;padding-left: 550px;padding-top: 50px;">CEO: Write to me</h4>

    <p style="padding-left: 50px;padding-right: 100px; font-size: 17px;">I’m always interested to hear from anyone who wishes to get in touch with me. Whether you have a partnership proposal, or a killer idea to share with<br><br> me, or just to poke me and say ‘HELLO’.. remember it’s good to talk! email me on sahutechnologies@gmail.com</p>
  </div>
