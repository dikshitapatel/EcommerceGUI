...
<h5 class="text-divider" style="font-size: 25px; color: red; background-color: transparent;padding-left: 600px "><span style="background-color: #fcfcfa"><b> Media Enquiries</b></span> </h5>
<p style="text-align: left;padding-left: 100px;padding-right: 100px;font-size: 17px;">
  If You’re From The Media And Would Like To Talk To Us, Kindly Email us   Media Enquiry  Email id- info@klassyink.com .<br> We Respond Immediately.
</p>
    </div>
</div>
