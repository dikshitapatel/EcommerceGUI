...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/c1.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/c2.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Assignment<br></h4></a>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/c3.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/c4.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/c5.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;"><br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;">Engineer Zinda ha Black<hr>
      </p>
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      <a href="#" class="text-muted" style="float: right;"><span class="glyphicon glyphicon-th-list" style="color: black;"></span>&nbsp;Details </a>
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/c6.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
