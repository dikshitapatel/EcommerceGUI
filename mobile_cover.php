...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Ek Number<br></h4></a>
...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Ayegi Jayegi<br></h4></a>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Die Ride<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/m9.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/m11.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/m10.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Ek Cutting Chai dena<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
     ...
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      ...
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/m12.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Ek Tha Engineer<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left">
            <img class="card-img-top" src="imgs/m13.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            <img class="card-img-top" src="imgs/m14.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            <img class="card-img-top" src="imgs/m15.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Get drunk<br></h4>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
     ...
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      ...
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 0px; padding-top:0px;text-align: left;">
            <img class="card-img-top" src="imgs/m16.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 0px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Groove<br></h4>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
