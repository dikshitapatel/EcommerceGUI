...
<div class="row">
  <div class="col-sm-8" style="padding-left: 110px;">
    <img src="imgs/blog3.jpg" alt="sorry" style="width: 850px;height: 550px;padding: 20px;">

    <h3 style="text-align: left; font-weight: bold;">THE STORY BEHIND OUR LOGO COLOR!</h3>
    <h2 style="color: red; font-weight: bold;">THE STORY BEHIND OUR LOGO COLOR!

<br></h2><br>
    <p style="text-align: left;font-size: 18px;line-height: 1.5; font-weight: lighter;">
      What is the first thing that makes you notice a company? For most of us, it’s usually the company logo that draws our attention. Even within the logo, great attention is paid to the colours used to represent a company.
<br>
