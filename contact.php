...
<div id="caption"  class="row">
 ...
 <h4 class="text-divider" style="font-size: 20px; color: black; background-color: transparent; "><span style="background-color: #fcfcfa"><b>Contact &nbsp;&nbsp; Us</b></span> </h4>

<div class="row">
  <div style="padding-left: 150px; padding-top:50px;padding-bottom: 50px;
  text-align: left; font-size: 20px; font-weight:100;">
    <form action="#" method="POST">
      Your Name(required) <br><br>
      <input type="text" name="name" required style="width: 500px;"><br><br>
      Your Email(required) <br><br> 
      <input type="email" name="email" required style="width: 500px;"><br><br> 
      Subject <br> <br>
      <input type="text" name="subject" required style="width: 500px;"><br><br> 
      Message <br><br>
      <input type="text" name="name"  required style="width: 500px; height: 100px;"><br><br> 
      <input type="submit" name="send" style="background-color: blue; border-radius: 40%; padding: 10px; color: white">         
      
    </form>
  </div>
  <div style="padding-left:50px;text-align: left;padding-top: 30px">
<h3>KlassyInk ShowRoom and Design Studio<br><br></h3>
<h4>KlassyInk Brand<br><br>
LikeAboss,Vipul Niwas,<br><br>
Near Shani Mandir,<br><br>
TelkusWadi,<br><br>
Dombivali West,<br><br>
Maharashtra 421202<br><br>

Contact Number : +91 8080001300<br><br></h4>
   </div>
  </div>
