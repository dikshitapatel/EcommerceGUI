...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/f1.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/f2.png" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/f3.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/f4.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/f5.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Ek No<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;">Love Beer<hr>
      </p>
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      <a href="#" class="text-muted" style="float: right;"><span class="glyphicon glyphicon-th-list" style="color: black;"></span>&nbsp;Details </a>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <img class="card-img-top" src="imgs/f6.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
