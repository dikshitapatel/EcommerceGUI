...
<div class="dropdown">
    ...
    <div class="dropdown-content" style="width:220px;height: 200px;padding:20px">
      <input type="text" name="username" placeholder="Username" style="width: 150px;height: 20px;"><br><br>
      <input type="password" name="password" placeholder="Password" style="width: 150px;height: 20px;"><br><br>
...
<div id="caption"  class="row">
  ...
  Home/Register</p>
    ...
    <div class="row" style="padding-left: 120px;font-size: 17px;font-weight: bold;text-align: left;padding-bottom: 120px;">
     <form action="register_val.php" method="POST" style="border:1px solid black;width:1000px; padding-left: 100px;">
...
<input type="submit" value="Register" name="reg_user" style="background-color: blue;color: white"><br><br>
</h3>
</form>
...
<div class="row" style="background-color: #000000; color: #ffffff;">
  ...
  <div class="col" style="text-align: left;">
    <h5 style="padding-left: 0px;">SIGN UP FOR OUR NEWS LETTER!</h5>
    <br><br>
    <h4>info@klassyink.com</h4>
    <form action="#" method="POST" style="text-align: left;width:50px;">
    <input type="text" name="email2" placeholder="info@klassyink.com" style="width: 160px;"><br><br>
