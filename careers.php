...
<div class="container">
    ...
    <h4 class="text-divider" style="font-size: 40px; color: red; background-color: transparent; "><span style="background-color: #fcfcfa"><b>Career With Us</b></span> </h4>
       
  
</div>
<div class="container">
  <h4 style="font-size: 40px; color: red;"><b>Working at Klassyink<br><br></b></h4>
</div>
<div class="container" style="text-align: left">
  <p style="font-size: 18px; line-height: 30px;"><b>
    Do You Want To Join A Most Innovative Team Of People With The Ambition To Change The World?<br><br>

Great Career Opportunities. Truly Cool Colleagues. Millions Of Individuals Who Love Our Destinations. Think That Its All Here At The World’s Biggest Upcoming fashion and apparel Site. Join The Shopping Revolution! Kindly Submit Your Passionate Resume In Our Career Portal
  </b><br><br>
</p>
<h4> <b>Job openings For Internship<br><br></b></h4>
<ol >
  <h4>
  <li style="border-bottom-color: #ffffff">Digital Marketing Manager</li>
  <li style="border-bottom-color: #ffffff">Software Developer</li>
  <li style="border-bottom-color: #ffffff">Software and Manual Taster</li></h4>
</ol>
<h4> <b>Job openings For Full Time<br><br></b></h4>
<ol >
  <h4>
  <li style="border-bottom-color: #ffffff">Software Developer</li>
  <li style="border-bottom-color: #ffffff">Graphic Designer</li>
  <li style="border-bottom-color: #ffffff">Marketing Manager</li></h4>
</ol><br>
<p style="font-size:18px; ">Kindly email us your resume to  info@klassyink.com  and  fill the  below career form.

</p>
<center><input type="button" name="career" value="Fill the Career Form" style="width: 200px; height: 
40px; background-color: pink"></center><br><br>
