...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">36 Ayegi Jayegi<br></h4></a>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Alcoholic<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Anpadh<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
    ...
    <div class="col-sm-3" style="padding: 20px;">
     ...
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      ...
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Certified Fit Ligth milanese<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Drink Pehle<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
