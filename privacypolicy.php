...
<div id="caption"  class="row">
  ...
  Home/PrivacyPolicy</p>
</div><br><br><br>
    </div></div>



    <div class="row" style="padding-left: 120px;font-size: 17px;font-weight: bold;text-align: left;padding-right: 100px;">
     
<h2 style="color: red;padding-left: 400px;font-weight: bolder;">Terms And Conditions<br><br></h2>
     <br><br>Privacy Policy<br><br>

Personal Information
<br><br>
KlassyInk Brands is a division of sahu Technologies DOES NOT trade or sell your personal information in any manner, except as specified herein or if you express your consent towards the same.<br><br>

Personal Information provided by you is used only:<br><br>
(a) To facilitate your use of the website;<br>
(b) To respond to your concerns, inquiries or address your requests for information about the various services we offer;<br>
(c) To provide you with information about Company’s services/products and send you information, materials and offers from the Company;<br>
(d) To send you important information regarding the website, changes to Company’s Terms of Service and various policies and/or other miscellaneous information;<br>
(e) To send you surveys and marketing communications that the Company believes may be of interest to you;<br>
(f) To personalize your experience on our website;<br>
(g) If you purchase any content or avail of any service from the website, to complete and fulfill Your purchase, for example, to have your payments processed, communicate with you regarding Your purchase and provide you with related customer service;<br>
(i) To administer product downloads;<br>
(j) To conduct internal reviews and data analysis for the Website (e.g., to determine the number of visitors to specific pages within the website);<br>
(k) To improve the services, content and advertising on the website;<br>
(l) To protect the integrity of the website; and<br>
(m) To comply with legal requirements and disclosures provided under the laws of India.<br>
Security :<br><br>

The security of your personal information is very important to the Company. We have aligned physical, administrative and technical safeguards designed to protect your personal information from unauthorized access. In addition, the Company uses standard security protocols and mechanisms to exchange the transmission of sensitive data such as credit card details. In the event of any breach of your personal information, the Company will notify you of it by email or fax and will restore the integrity of the data system.<br><br>
Advertising:<br><br>
The Company uses some third parties to administer a limited set of advertisements on our website and portals. During this process, no personal information is leaked. However, aggregate profile information, such as user community, may be used in the selection of advertising to make sure that it has relevance to the user. On some banner ads, an embedded pixel may be present, and while it does not associate with a cookie or other personal profile information, it may return session connection information that allows advertisers to better determine how many individual users have clicked on the ad banner.<br><br>
User Discretion:<br><br>
You can always choose not to provide information and in such cases, if the information required is mandatory, you will not be able to avail those services, features or contents.You can add or update your personal information on a regular basis. When you update information, the Company will keep a copy of the prior version for its records.<br><br>

The Company may, if you prefer, send direct advertisement mailers to you at the address given by you. You have the option to opt-out of this direct mailer by clicking at the unsubscribed link option attached to e-mail. The Company respects your privacy and if you do not want to receive any kind of communications from klassyink.com or have any grievances to share, please report to info@klassyink.com<br><br>
Important Disclaimer:<br><br>
Although the Company provides full security and secrecy to your personal information, we urge you to be careful with very sensitive information and do not share it with any third party claiming to be related to the Company on separate emails/phone calls etc. The Company disclaims any and all liabilities towards any such claims that have arisen due to your own negligence or willful misconduct and the Company takes no responsibility of the same.
We are committed to protecting your personal information. Although we may collect certain personal info from your viz. your name, address, telephone number, e-mail address etc., under no circumstances do we rent, lease or sell this information to third parties.<br><br>

Why we need your personal information?<br><br>

We need your personal information for authenticating you as well as sending you products as and when you buy them from klassyink. We require information like telephone number and address to give you immaculate services.<br><br>

In some cases, we may also personal information like your e-mail address for direct marketing purposes and for sending company’s newsletters. However, you can always choose not to opt for direct marketing mailers or newsletters by clicking the appropriate option at the time of sign-up.<br><br>

Security system in place:<br><br>

We made sure that there are enough levels of security in place to ensure your information remains safe with us. We have put in place robust electronic authorization systems to protect your privacy at all times.<br><br>

Why we use cookies:<br><br>

Cookies are small files which are used to track a person’s web behavior. We too save these cookies from your previous visit to give you a better browsing experience at klassyink. Cookies help us to determine your usage patterns, what you like and what you dislike. All that helps us to give you the most relevant pages when you visit klassyink again.<br><br>

Cookies are enabled in web browsers by default. A cookie doesn’t give us or any other party any advantage related to your computer data or personal info, other than what you choose to disclose. However, if you feel insecure about cookies (although there is no reason to), you can always disable them in your browser settings. Doing so might not allow you to experience klassyink to its fullest.<br><br>

Other websites<br><br>

klassyink might contain links to other websites for advertising purposes. We are responsible for privacy protection on our website only, and if you choose to redirect yourself to these third party websites form klassyink , we take no responsibility for your loss of sensitive data. Personal discretion is advised at all times.<br><br>

We may update our privacy policy from time to time, and you will be promptly informed each time it happens. We are committed to protecting your identity online and would never do anything that jeopardizes your security.<br><br>
</div>
