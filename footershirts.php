...
<div class="row">
  ...
  <div class="col-sm-3" style="padding: 20px;text-align: left;padding-left: 40px;font-size: 17px;">
      <label>Search products</label><br><br>
    <input type="text" name="search" placeholder="Search"><br><br>

    <img src="imgs/freeshipping.webp" alt="sorry" style="width: 280px;height: 450px;">
     </div>
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
                            <a href="Tshirt-details.php" style="color: black;">

            <img class="card-img-top" src="imgs/fo1.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Engineering mazak ha kya??<br></h4></a>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo2.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Certified Fit<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo3.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Certified fit Dark<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
...
<div class="row">
<div class="col-sm-3" style="padding: 20px;">
  <h5 style="padding-left: 50px;font-weight: bolder;text-align: left;">Product Categories</h5>
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo4.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Army brat Maroon<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo5.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Army Brat black<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo6.png" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Apna drop ayega<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      349.00<br>
        <hr style="padding: 0px;"><hr>
...
<div class="row">
<div class="col-sm-3" style="padding: 20px;text-align: left; padding-left: 40px">
  <label>Search products</label><br><br>
    <input type="text" name="search" placeholder="Search"><br><br>
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
                                  ...
                                  <a href="Cover-details.php" style="color: black;">

            <img class="card-img-top" src="imgs/fo7.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Drink pehle soch Later<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo8.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Army Brat <br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo9.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Certified fit Yellow<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo10.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Cycopath<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo11.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Groove<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
     ...
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      ...
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo12.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Indian Army<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
  ...
  <div class="col-sm-3" style="padding: 20px;">
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo13.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Awaara<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
    ...
    <div class="col-sm-3" style="padding: 20px;">
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo14.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Get Drunk<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
     ...
     <a href="#" class="text-muted" style="float: left;"><span class="glyphicon glyphicon-shopping-cart" style="color: black;"></span>&nbsp;Add to Cart </a>
      ...
      <div class="card border-dark" style="width: 280px;border-color: 1px solid black; padding: 5px; padding-top: 1px;text-align: left;">
            ...
            <img class="card-img-top" src="imgs/fo15.jpg" alt="Card image" style="width:100% ;height: 350PX; padding: 5px;">
            <div class="card-body">
      <h4 class="card-title" style="font-weight:bold;">Biker<br></h4></a>
      <p class="card-text" style="font-size: 16px;">
        <i class="fa fa-inr" style="font-size:16px;color: black;"></i>
      250.00<br>
        <hr style="padding: 0px;"><hr>
