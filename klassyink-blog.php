...
<div id="caption"  class="row">
  <p style="text-align: center; padding-left: 45% ;color: black;font-size: 18px;font-weight: bolder;">
  Klassyink Blog</p>
</div></div>
<div class="row">
  <div class="col-8" style="text-align: left; padding: 50px;padding-left: 120px;">
      <a href="klassyink-got-name.php">
      <img src="imgs/blog1.jpg" style="width:300px; height: 180px; padding-right: 20px;padding-top: 20px" align="left">
     
      <h3 style="font-weight: bold;">HOW Klassyink GOT ITS NAME! </h3></a>
      <p style="font-size: 18px; line-height: 30px;">HOW KlassyInk GOT ITS NAME! How we Settled on a Unique Name Our founders, Jitendra sahu, wanted to do something unique and they started this with choosing a unique name. Not wanting to succumb to the usual done-to-death names that were already popular in the market. One thing led to another, and they settled on a name that they thought [...]</p>
      <hr>
      <small class="text-muted">By KlassyInk Brand| September 9th, 2015|Categories: Markup, News, Trends|Tags: klassyink, klassyink brand, tshirt|<a href="#" style="float: right" class="text-muted">Read More></a><br>6,395 Comments</small>
      <hr>
      <a href="blog-e-magazine.php">
      <img src="imgs/bookblog.jpg" style="width:300px; height: 180px; padding-right: 20px;padding-top: 20px" align="left">
     
      <h3 style="font-weight: bold;">KlassyInk GETS FEATURED IN THE 'Ideapreneur E-Magazine'! </h3></a>
      <p style="font-size: 18px; line-height: 30px;">KlassyInk GETS FEATURED IN THE ‘Ideapreneur India E-Magazine’! KlassyInk got featured in the retailer magazine. The feature is an industry story on brand licensing and the big business T-shirts. The article, ‘The Big Business of T-shirts’ talks about some of the popular T-shirt brands of the day. Ideapreneur India E-Magazine provides an insight into the retail sector, and covers [...]</p>
      <hr>
      <small class="text-muted">By KlassyInk Brand| September 9th, 2015|Categories: Markup, News, Trends|Tags: klassyink, klassyink brand, tshirt|<a href="#" style="float: right" class="text-muted">Read More></a><br>6,395 Comments</small>
      <hr>
      <a href="blog-logo-color.php">

      <img src="imgs/blog3.jpg" style="width:300px; height: 180px; padding-right: 20px;padding-top: 20px" align="left">
     
      <h3 style="font-weight: bold;">THE STORY BEHIND OUR LOGO COLOR! </h3></a>
      <p style="font-size: 18px; line-height: 30px;">THE STORY BEHIND OUR LOGO COLOR! What is the first thing that makes you notice a company? For most of us, it’s usually the company logo that draws our attention. Even within the logo, great attention is paid to the colours used to represent a company. Since logos are essential in making an impression, we at KlassyInk decided to create [...]</p>
      <hr>
      <small class="text-muted">By KlassyInk Brand| September 9th, 2015|Categories: Markup, News, Trends|Tags: klassyink, klassyink brand, tshirt|<a href="#" style="float: right"class="text-muted">Read More></a><br>6,450 Comments</small>
      <hr>
      <a href="blog-enthusiasts.php">
      <img src="imgs/blog4.jpg" style="width:300px; height: 180px; padding-right: 20px;padding-top: 20px" align="left">
     
      <h3 style="font-weight: bold;">SHOUT OUT TO ASPIRING CREATIVE ENTHUSIASTS! </h3></a>
      <p style="font-size: 18px; line-height: 30px;">SHOUT OUT TO ASPIRING CREATIVE ENTHUSIASTS! KlassyInk.com, India’s fastest growing casual fashion and merchandise wear brand is at the forefront of a major shift in the fashionise industry. Come, be a part of this revolution. We are looking for Impressive Interns! We’re building Great Things that can Change the Face of Fashion,merchandise and we need your Talent! Aspiring Intern 1.Must [...]</p>
      <hr>
      <small class="text-muted">By KlassyInk Brand| July 31st, 2012|Categories: Creative, Design, Videos|Tags: klassyink, klassyink brand, tshirt|<a href="#" style="float: right;" class="text-muted">Read More></a><br>3,768 Comments</small>
      <hr>
  ...
  <div class="panel panel-default" style="width: 300px; ;">
    ...
    <div class="panel-body">
      ...
      <div class="row">
       ...
       <a href="blog-e-magazine.php">
        <img src="imgs/bookblog.jpg" style="width: 60px;height: 50px;" align="left"></a>
          <a href="blog-e-magazine.php" style="color: black;font-size: 16px; line-height: 2">KlassyInk GETS FEATURED IN THE 'Ideapreneur India E-Magazine'</a>
          <br>
