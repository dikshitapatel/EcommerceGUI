...
<div id="caption"  class="row">
  ...
  Home/Klassyink Stores</p>
</div><br><br><br>
    </div></div>
    <div class="row" style="padding-left: 120px;font-size: 17px;font-weight: bold;text-align: left;">
     
<h4 style="color: red;padding-left: 450px;font-weight: bolder;">Franchise Enquiry<br><br></h4>
Do you want to open a physical store in Your local area in the name of our brand so kindly email us:
info@klassyink.com <br><br></p>
     <br>
    </div>
