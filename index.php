    ...
    <div class="fusion-align-left" style="padding-left: 0px;">
      <div class="fusion-social-links-header" style="padding-left: 120px; text-align: left;">
        ...
        <div class="fusion-social-networks-wrapper" style="padding-left: 0px">
            ...
            <a href="https://www.instagram.com" class="fa fa-instagram" style="padding-top: 5px;" title="Instagram"></a>
            <a href="https://www.pininterest.com" class="fa fa-pinterest" style="padding-top: 5px;" title="Pinterest"></a>        

         <a href="careers.php" style="color: black;padding-left: 500px;padding-right: 10px;font-weight: bolder;">Careers</a>
...
<div class="container" style="padding-top: 160px;">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
      <li data-target="#myCarousel" data-slide-to="0" class="active" style="border-radius:50%; height:0.5px; width: 0.5px;" ></li>
      <li data-target="#myCarousel" data-slide-to="1" style="border-radius:50%; height: 0.5px; width: 0.5px;"></li>
      <li data-target="#myCarousel" data-slide-to="2" style="border-radius:50%; height: 0.5px; width: 0.5px;"></li>
      <li data-target="#myCarousel" data-slide-to="3" style="border-radius:50%; height: 0.5px; width: 0.5px;"></li>
      <li data-target="#myCarousel" data-slide-to="4" style="border-radius:50%; height: 0.5px; width: 0.5px;"></li>
    ...
    <div class="carousel-inner">
      ...
      <a href="graphic-tshirts.php">  <img src="imgs/3shirt.jpg" alt="Shirts" style="width:100%; height: 400px;"></a>
        
      </div>

      <div class="item">
       <a href="graphic-tshirts.php"> <img src="imgs/coupleshirt.jpg" alt="Shirts" style="width:100%; height:400px;"></a>
        
      </div>
    
      <div class="item">
        <a href="graphic-tshirts.php"><img src="imgs/mob_cover.jpg" alt="MobileCovers" style="width:100%; height:400px;"></a>
       
      </div>
  

      <div class="item">
        <a href="graphic-tshirts.php"><img src="imgs/mug.jpg" alt="Mug" style="width:100%; height:400px;"></a>
       
      </div>
  

      <div class="item">
        <a href="graphic-tshirts.php"><img src="imgs/printT.jpg" alt="T-shirts" style="width:100%; height:400px;"></a>
...
<div class="row" style="padding-left: 120px; padding-right: 100px;">
<div><span><a href="graphic-tshirts.php"><img src="imgs/graphictee.jpg" style="width:380px; height:450px; padding: 25px;" /></a></span></div>
<div><span><a href="graphic-tshirts.php"><img src="imgs/MOBILECOVER.jpg" style="width:380px; height:450px; padding: 25px;" /></a></span></div>
<div><span><a href="graphic-tshirts.php"><img src="imgs/design.jpg" style="width:380px; height:450px; padding: 25px;" /></a></span></div>
 </div>
 <div class="row" style="padding-left: 120px; padding-right: 100px;">
<div class="col-sm-4"><span><a href="plain-t-shirts.php"><img src="imgs/tshirts.jpg" style="width:380px; height:450px; padding: 25px;" /></a></span></div>
<div class="col-sm-8"><span><a href="graphic-tshirts.php"><img src="imgs/coupleshirt.jpg" style="width:760px; height:450px; padding: 25px;" /></a></span></div>
 </div>
 <div class="row" style="padding-left: 130px; padding-right: 100px;">
<div ><span><a href="graphic-tshirts.php"><img src="imgs/Tcat.jpg" style="width:570px; height:400px; padding: 25px;" /></a></span></div>
<div><span><a href="graphic-tshirts.php"><img src="imgs/mobcat.jpg" style="width:570px; height:400px; padding: 25px;" /></a></span></div>
 </div>
 <div class="row" style="padding-left: 130px; padding-right: 100px;">
<div ><span><a href="graphic-tshirts.php"><img src="imgs/regionalT.jpg" style="width:570px; height:400px; padding: 25px;" /></a></span></div>
<div><span><a href="graphic-tshirts.php"><img src="imgs/mug.jpg" style="width:570px; height:400px; padding: 25px;" /></a></span></div>
 </div>
 <div class="row" style="padding-left: 130px; padding-right: 100px;">
<div ><span><a href="#"><img src="imgs/link.jpg" style="width:1140px; height:200px; padding: 25px;" /></a></span></div>
</div>
<h4 class="text-divider" style="font-size: 25px; color: black; background-color: transparent; "><span style="background-color: #fcfcfa"><b>Our Most Recent Blogs</b></span> </h4>


<div class="row" style="padding-left: 150px; padding-right: 130px; padding-top: 20px;">
  <div class="card-deck">
        <div class="card mb-4">
          <div class="zoomin frame" style="width: 100%;">
            <a href="klassyink-got-name.php">
      <img src="imgs/blog1.jpg"  title="Scale on Hover with Transition using CSS" style="width: 350px;"  />
        </div>
            <div class="card-body">
              <h4 class="card-text" style="text-align: left;">HOW KlassyInk GOT ITS NAME!</h4></a>
     <p class="card-text" style="text-align: left;"> <small class="text-muted" >September 9th, 2015|6,395 Comments</small></p>
                <p class="card-text" style="text-align: left;">HOW KlassyInk GOT ITS NAME! How we Settled on a Unique Name Our [...].</p>
            </div>
        </div>
        <div class="card mb-4">
      <div class="zoomin frame" style="width: 100%;">
        <a href="blog-e-magazine.php">
      <img src="imgs/blog2.jpg"  title="Scale on Hover with Transition using CSS" style="width: 350px;"/>
        </div>            
                <div class="card-body">
                <h4 class="card-text" style="text-align: left;">KlassyInk GETS FEATURED IN THE 'Ideapreneur India India E-Magazine'!</h4></a>
     <p class="card-text" style="text-align: left;"> <small class="text-muted" >September 9th, 2015|6,578 Comments

</small></p>
                <p class="card-text" style="text-align: left;">KlassyInk GETS FEATURED IN THE ‘Ideapreneur India E-Magazine’! KlassyInk got featured in [...]</p>
                 </div>
        </div>
        <div class="w-100 d-none d-sm-block d-md-none"><!-- wrap every 2 on sm--></div>
        <div class="card mb-4">
            <div class="zoomin frame" style="width: 100%;">
              <a href="blog-logo-color.php">
      <img src="imgs/blog3.jpg"  title="Scale on Hover with Transition using CSS" style="width: 350px;"/>
      </div>
            <div class="card-body">
                <h4 class="card-text" style="text-align: left;">THE STORY BEHIND OUR LOGO COLOR!</h4></a>
     <p class="card-text" style="text-align: left;"> <small class="text-muted" >September 9th, 2015|6,445 Comments


</small></p>
                <p class="card-text" style="text-align: left;">THE STORY BEHIND OUR LOGO COLOR! What is the first thing that makes [...]</p>
                 </div>
        </div>
 </div>
</div>
<div class="row" style="background-color: #ffe500 ">

  <div class="col-sm-4" style="padding-left: 150px;"><p style="letter-spacing: 4px; font-size: 18px; padding-top: 25px; line-height:180%; text-align: left; "><strong><span style="color: #000000;">GET DISCOUNTS EVERYDAY TO YOUR EMAIL</span></strong></p>
    <p style="text-align: left;">
      <input type="email" name="email" placeholder="Insert your email">&nbsp;<input type="button" name="send" value="SEND" style="border-radius: 10px;background: #427ed1;
    color: #ffffff; height: 30px; width: 60px;">
    </p>
  </div>
  <div class="col-sm-4"><h2 style="text-align: center; font-size: 32.585px; line-height: 40.302px;" data-fontsize="38" data-lineheight="47"><span style="color: #000000;"><strong>FAN PAGE</strong></span></h2>
    <div class="zoom" style="width: 100%;">
     <a href="fanpage.php"> <img src="imgs/fan.jpg"   style="width: 250px; height: 100px; "  /></a>
        </div>
  </div>
  <div class="col-sm-4" style="padding-right: 110px;"><p style="letter-spacing: 4px; font-size: 18px; padding-top: 25px; line-height:180%"><span style="color: #000000;"><strong>FOLLOW US IN OUR SOCIAL NETWORKS</strong></span></p>
        <div class="fusion-social-networks-wrapper" style="padding-left: 0px; ">
            <a href="https://www.facebook.com" class="fa fa-facebook" style="padding-top: 5px; background-color: transparent; color: #000000; font-weight: bold; font-size: 20px;" title="Facebook"></a>
            <a href="https://www.twitter.com" class="fa fa-twitter" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Twitter"></a>
            <a href="https://www.google.com" class="fa fa-google" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Google"></a>
            <a href="https://www.linkedin.com" class="fa fa-linkedin" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Linkedin"></a>
            <a href="https://www.youtube.com" class="fa fa-youtube" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Youtube"></a>
            <a href="https://www.instagram.com" class="fa fa-instagram" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Instagram"></a>
            <a href="https://www.pininterest.com" class="fa fa-pinterest" style="padding-top: 5px; background-color: transparent; color: #000000;font-weight: bold; font-size: 20px;" title="Pinterest"></a>
...
<div class="row" style="background-color: #000000; color: #ffffff;">
  ...
  <div class="col" style="text-align: left;"><h5 style="padding-left: 50px;">NEED HELP??</h5>
    <ul style="font-size: 17px; list-style-type: none;  text-align: left; word-spacing: 3px;" >
     ...
     <a href="footershirts.php"> <li>>  Plain T-Shirts</li></a>
      ...
      <a href="fanpage.php"><li>>  KlassyInk Fan</li></a>
