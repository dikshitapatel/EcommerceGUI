...
<div id="caption"  class="row">
  ...
  KLASSYINK GOT NAME</p>
</div></div>

<div class="row">
  <div class="col-sm-8" style="padding-left: 110px;">
    <img src="imgs/blog1.jpg" alt="sorry" style="width: 850px;height: 550px;padding: 20px;">

    <h3 style="text-align: left; font-weight: bold;">HOW KlassyInk GOT ITS NAME!</h3>
    <h2 style="color: red; font-weight: bold;">HOW KlassyInk GOT ITS NAME!<br></h2><br>
    <h4 style="padding-left: 50px;font-weight: bold;">How we Settled on a Unique Name</h4><br>
    <p style="text-align: left;font-size: 20px;line-height: 1.5; font-weight: lighter;">
      Our founders, Jitendra sahu, wanted to do something unique and they started this with choosing a unique name. Not wanting to succumb to the usual done-to-death names that were already popular in the market. One thing led to another, and they settled on a name that they thought would stick around with their fanbase! Three years down the line, it has proved to be catchy and how!<br><br>
    </p>
    <h4 style="font-weight: bold;text-align: left;">The Eureka Moment which Led them to Choose the Name</h4>
    <p style="text-align: left;font-size: 20px;line-height: 1.5; font-weight: lighter;">
      our founder skipped high paying job interviews and college placements to chase their dream of building a start up like no other. They were often tagged as KlassyInk and ironically that’s when they thought of creating a fashion brand that had its roots in the philosophy, ‘Follow your heart’. </p><br>
 
 <h4 style="font-weight: bold;text-align: left;">What We Wanted Our Customers to Think About “KlassyInk”</h4>
    <p style="text-align: left;font-size: 20px;line-height: 1.5; font-weight: lighter;">
     Whenever they would mention our brand name KlassyInk to people, they would get amused expressions or chuckles in response. They found victory in such responses and achieved memorability amongst fans as well.</p><br>
 <h4 style="font-weight: bold;text-align: left;">Stay tuned for more things KlassyInk!
  ...
  <div class="panel panel-default" style="width: 300px;">
    <div class="panel-heading" style="height: 50px;padding:5px;padding-left: 15px;">
     <ul style="display: inline-block; padding-left: 0px;padding-right: 0px;">
          <li style="display: inline-block; padding: 15px ;font-size:18px; font-weight: bold; border-bottom-color:transparent; color: black;"><a href="">Popular</a></li>
          <li style="display: inline-block;padding: 15px;font-size:18px; font-weight: bold;border-bottom-color: transparent; color: black;"><a href="">Recent</a></li>
